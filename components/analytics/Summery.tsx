...
const Summery = () => {
    ...
    return (
        <div className='grid lg:grid-cols-3 gap-6'>
            <div className='bg-[#757FEF] min-h-36 rounded-md xl:col-span-1 col-span-full p-7 text-white'>
            ...
            <div className='min-h-36 xl:col-span-1 col-span-3/2'>
                <div className='bg-white rounded-md flex items-center gap-5 p-7 shadow-sm lg-col-span-2'>
            ...
            <div className='h-50 xl:col-span-1 col-span-3/2'>
                <div className='bg-white rounded-md flex items-center gap-5 p-7 shadow-sm lg-col-span-2'>
                    <div className='bg-[#EAEEFD] text-[#757FEF] p-4 rounded-md'>
                        <Goal size={40} />
                    </div>
